...
namespace HHVacancy.Core.Test
{
    [TestClass]
    public class VacancyServiceUnitTest
    {
        private static IVacancyApiService _apiService => ServicesContainer.GetService<IVacancyApiService>();
        ...
        private static IEnumerable<int> GetRandomVacancyIds(byte count)
        {
            ...
            VacancySearchResult searchPageResult = _apiService.GetVacancySearchPage(request)
                .GetAwaiter()
                .GetResult();
        ...
        {
            var vacancyFullModel = await _apiService.GetVacancyById(vacancyID);
        ...
        public async Task TestGetVacancySearchPage(int pageSize)
        {
            ...
            VacancySearchResult vacancySearchPageModel = await _apiService
...

        {
            ...
            await foreach (var vacancyResult in
                _apiService.SearchVacancies(vacancySearchRequest))
            {
